...
/*
  Ignore occasional missed frames.
  Do not replace an active AI state with
  "Pose not detected" when pose data already exists.
*/
if (
  !results ||
...
return ( <div className="min-h-screen bg-slate-50 p-4 md:p-6"> <div className="mx-auto max-w-7xl space-y-6">
